...
async def ingest_content(
    ...
    try:
        ...
        # Skip embeddings for MVP - just create a dummy index
        logger.info("Creating simple index", page_url=request.page_url)
        index = None  # We'll use simple text search instead
